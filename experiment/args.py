...
class Args:
    def __init__(self):
        ...
        self.parser.add_argument('--device', default='cuda:0' if torch.cuda.is_available() else 'cpu',
                                 help='cuda:[d] | cpu')
        self.parser.add_argument('--seed', type=int, default=3407, help='random seed to reproduce performance/dataset') # 114514，3407，42
        ...
        self.parser.add_argument('--use_vib', action='store_true', default=False, help="Use CVIB bottleneck")
        self.parser.add_argument('--beta_node', type=float, default=0.01, help="Beta for node bottleneck")
        self.parser.add_argument('--beta_edge', type=float, default=0, help="Beta for edge bottleneck")
